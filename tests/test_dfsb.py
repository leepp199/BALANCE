...
from models.dfsb import DeepFeatureStructureBank, descriptor_matrix


class DeepFeatureStructureBankTest(unittest.TestCase):
    def test_shapes_normalization_and_finiteness(self):
        torch.manual_seed(7)
        bank = DeepFeatureStructureBank(torch.randn(8, 512), temperature=0.2)
